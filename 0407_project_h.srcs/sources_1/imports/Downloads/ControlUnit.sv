...
module ControlUnit (
    ...
    always_comb begin : state_next_machine
        ...
        case (state)
            ...
            S0: begin // R1 = 1;
                out_signals = 15'b1_000_000_001_1_1_000;
                state_next     = S1;
            end
            S1: begin // R2 = 0;
                out_signals = 15'b0_000_000_010_1_1_000;
                state_next     = S2;
            end
            S2: begin // R3 = 0;
                out_signals = 15'b0_000_000_011_1_1_000;
                state_next     = S3;
            end
            S3: begin // R4 = R1 + R1;
            ...
            S6: begin // R2 = R6 and R4 = 5
                out_signals = 15'b0_110_100_001_1_1_010;
                state_next     = S7;
            end 
            S7: begin // R3 = R2 or R5 = 6
                out_signals = 15'b0_001_101_011_1_1_011;
                state_next     = S8;
            end
            S8: begin // R7 = R3 xor R2 = 4
                out_signals = 15'b0_011_100_111_1_1_100;
                state_next     = S9;
            end
            S9: begin // not R7 = 3
                out_signals = 15'b0_111_000_111_1_1_101;
                state_next     = S10;
            end
            S10: begin // if (R7 > R4) goto S4 
                out_signals = 15'b0_111_100_000_0_1_000;
